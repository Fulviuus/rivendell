...
fn seed_profiles(conn: &Connection) -> rusqlite::Result<()> {
    let profiles: &[(&str, &str, &str, &str, &str, &str, &str)] = &[
        ...
        // The next three have no first-party CLI to launch, so they carry no
        // command: the kind is the identity — label and icon — and you run
        // whatever client speaks for them yourself.
        (
            "deepseek",
            "DeepSeek",
            "deepseek",
            ...
            r#"[]"#,
            "none",
            "DeepSeek, through whatever client you run for it.",
        ),
        (
            "grok",
            "Grok",
            ...
            r#"[]"#,
            "none",
            "xAI's Grok, through whatever client you run for it.",
        ),
        (
            "glm",
            "GLM",
            ...
            r#"[]"#,
            "none",
            "Zhipu's GLM, through whatever client you run for it.",
        ),
        (
            "shell",
            "Custom command",
